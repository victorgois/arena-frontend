    ...
    <div className="flex flex-row w-full justify-between">
      <div className="flex flex-col text-left text-base md:text-xl lg:text-xl mx-10 my-2 justify-center">
        <span>
          ...
          <p className="text-black text-xs font-playfair mt-4 w-1/2">
      ...
      <div className="flex flex-col w-full font-bold align-right text-sm md:text-base lg:text-lg text-right mx-10 my-10">
        <a
          className="hover:font-extrabold hover:text-red-500"
